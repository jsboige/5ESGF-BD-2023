...
namespace Sudoku.Mysolver
{
    ...
    public class SudokuRandomPermutationsChromosome : SudokuPermutationsChromosome
    {
        ...
        /// <param name="nbPermutations">the number of permutation genes per row</param>
        /// <param name="nbSudokus">the number of Sudokus generated for evaluation</param>
        public SudokuRandomPermutationsChromosome(GridSudoku targetGridSudoku, Dictionary<(int row, int column), List<int>> extendedMask, int nbPermutations, int nbSudokus) : base(targetGridSudoku, extendedMask, 9 * nbPermutations)
        {
        ...
        {
            var toReturn = new List<GridSudoku>(_nbSudokus);
        ...
        {
            return new SudokuRandomPermutationsChromosome(TargetGridSudoku, ExtendedMask, _nbPermutations, _nbSudokus);
        }
    }
}
